...
/*
whitelist = [ "^https.?://maundys.net$", "maundys.net$", "test\\..*" ];  // regexp for whitelisted urls
*/
...
addEventListener("fetch", async event=>{
    event.respondWith((async function() {
        ...
        if ((!isListed(fetch_url, blacklist)) && (isListed(orig, whitelist))) {
            ...
            return new Response(
                "CREATE YA OWN YA LAZY FOOKER</br>\n" + 
                "<a href='https://github.com/Domin8-IPTV/CF-CORS'>https://github.com/Domin8-IPTV/CF-CORS</a></br>\n",
                {
                    status: 403,
